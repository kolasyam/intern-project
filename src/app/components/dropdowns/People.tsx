...
//   const [selectedItems, setSelectedItems] = useState<string[]>([]); // Add <string[]> here

//   const handleItemClick = (item: string) => { // Specify type for 'item'
...
//           <span key={index} className="bg-blue-100 text-blue-700 rounded-md px-2 py-1 mr-2">
//             {item} <span className="text-sm cursor-pointer" onClick={() => handleItemClick(item)}>×</span>
//           </span>
//         ))}
//         <button
...
//               <input type="radio" id="allUsers" name="group" value="All Users" />
//               <label htmlFor="allUsers" className="ml-2">All Users (400)</label>
//             </div>
//             <div className="flex items-center">
//               <input type="radio" id="managers" name="group" value="Managers" />
//               <label htmlFor="managers" className="ml-2">Managers (14)</label>
//             </div>
//             <div className="flex items-center">
//               <input type="radio" id="trainers" name="group" value="Trainers" />
//               <label htmlFor="trainers" className="ml-2">Trainers (4)</label>
//             </div>

//             <h2 className="text-sm font-semibold mt-4">Users</h2>
//             <div className="flex items-center">
//               <input
//                 type="checkbox"
//                 id="adrianLu"
...
//               />
//               <label htmlFor="adrianLu" className="ml-2">Adrian Lu</label>
//             </div>
//             <div className="flex items-center">
//               <input
//                 type="checkbox"
...
//               />
//               <label htmlFor="evelynHamilton" className="ml-2">Evelyn Hamilton</label>
//             </div>
//           </div>
//           <div className="p-2 border-t">
//             <button className="w-full bg-blue-500 text-white py-2 rounded-md" onClick={handleClear}>
//               Clear
//             </button>
//           </div>
//         </div>
